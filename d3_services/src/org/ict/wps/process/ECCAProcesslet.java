...
public class ECCAProcesslet implements Processlet {

  private static final Logger LOG = LoggerFactory.getLogger( ECCAProcesslet.class );
  ...
  public void process( ProcessletInputs in, ProcessletOutputs out, ProcessletExecutionInfo info ) throws ProcessletException {
    ...
    LOG.trace( "BEGIN ECCAProcesslet#execute(), context: " + OGCFrontController.getContext() );
    ...
    LOG.trace( "END ECCAProcesslet#execute()" );
  }

  public void destroy() {
    LOG.debug( "ECCAProcesslet#destroy() called" );
  }

  public void init() {
    LOG.debug( "ECCAProcesslet#init() called" );
  }
