...
public interface Classifier {
  ...
  /**
   * Возвращает результат "скользящего экзамена".
   *
   * Возвращает число неверно классифицированных точек обучающей выборки.
   * Классифицируемая точка ОВ, не участвует в классификации самой себя.
   *
   * @return число ошибочно классифицированных точек обучающей выборки
   */
