//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/wpvs/rendering/jogl/GetViewRenderer.java $
/*----------------------------------------------------------------------------
 ...
 * @version $Revision: 18446 $, $Date: 2009-07-13 23:06:15 +0700 (Пнд, 13 Июл 2009) $
 * 
 */
public class GetViewRenderer implements GLEventListener {
    ...
    public GetViewRenderer( GetView request, RenderContext glRenderContext, PooledByteBuffer imageBuffer,
                            TerrainRenderingManager demRenderer, List<TextureManager> textureManagers,
                            List<BuildingRenderer> buildingRenderers, List<TreeRenderer> treeRenderers,
    ...
    public void display( GLAutoDrawable drawable ) {
        ...
        demRenderer.render( context, renderDEM, tManager );
