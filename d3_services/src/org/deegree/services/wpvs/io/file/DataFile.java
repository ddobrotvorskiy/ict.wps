//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/wpvs/io/file/DataFile.java $
/*----------------------------------------------------------------------------
...
public class DataFile<T extends PositionableModel> {
     ...
     * @throws IOException
     */
    List<DataObjectInfo<T>> readAllFromFile( long from, long to )
                            throws IOException {
