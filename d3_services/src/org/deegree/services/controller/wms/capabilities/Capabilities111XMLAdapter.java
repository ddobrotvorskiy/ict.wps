//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/controller/wms/capabilities/Capabilities111XMLAdapter.java $
/*----------------------------------------------------------------------------
...
public class Capabilities111XMLAdapter extends XMLAdapter {
    ...
    private void writeStyle( XMLStreamWriter writer, String name, String title, Pair<Integer, Integer> legendSize,
        ...
        writeElement( writer, "Format", "image/gif" );
