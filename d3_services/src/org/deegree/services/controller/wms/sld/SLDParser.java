//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/controller/wms/sld/SLDParser.java $
/*----------------------------------------------------------------------------
 ...
 * 
 * @version $Revision: 21759 $, $Date: 2010-01-06 15:43:41 +0600 (Срд, 06 Янв 2010) $
 */
                ...
                if ( in.getLocalName().equals( "LayerFeatureConstraints" ) ) {
                    ...
                    while ( !( in.isEndElement() && in.getLocalName().equals( "LayerFeatureConstraints" ) ) ) {
                        ...
                        while ( !( in.isEndElement() && in.getLocalName().equals( "FeatureTypeConstraint" ) ) ) {
                            ...
                            // skip feature type name, it is useless in this context
