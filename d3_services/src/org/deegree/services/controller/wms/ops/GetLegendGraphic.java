//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/controller/wms/ops/GetLegendGraphic.java $
/*----------------------------------------------------------------------------
...
import static org.deegree.services.controller.wms.WMSController.supportedImageFormats;
 ...
 * 
 * @version $Revision: 21204 $, $Date: 2009-12-03 19:58:09 +0600 (Чтв, 03 Дек 2009) $
 */
public class GetLegendGraphic {
    ...
    public GetLegendGraphic( Map<String, String> map, MapService service ) throws OWSException {
        ...
        if ( !supportedImageFormats.contains( format ) ) {
            throw new OWSException( get( "WMS.UNSUPPORTED_IMAGE_FORMAT", format ), INVALID_FORMAT );
        }
