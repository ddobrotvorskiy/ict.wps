...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link PublishedInformation.GetFeatureInfoTemplate }
     * 
     */
    public PublishedInformation.GetFeatureInfoTemplate createPublishedInformationGetFeatureInfoTemplate() {
        return new PublishedInformation.GetFeatureInfoTemplate();
    }
