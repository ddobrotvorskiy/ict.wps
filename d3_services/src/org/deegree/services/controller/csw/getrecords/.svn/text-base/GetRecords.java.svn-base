...
public class GetRecords extends AbstractCSWRequest {
    ...
    public GetRecords( Version version, NamespaceContext namespaces, QName[] typeNames, String outputFormat,
                       ResultType resultType, String requestId, String outputSchema, int startPosition, int maxRecords,
                       ...
                       boolean distributedSearch, int hopCount, String responseHandler ) {
