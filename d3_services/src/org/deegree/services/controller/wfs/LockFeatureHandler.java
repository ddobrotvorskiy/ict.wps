//$HeadURL: http://wald.intevation.org/svn/deegree/deegree3/services/trunk/src/org/deegree/services/controller/wfs/LockFeatureHandler.java $
/*----------------------------------------------------------------------------
...
class LockFeatureHandler extends GetFeatureHandler {
     ...
     */
    LockFeatureHandler( WFSController master, WFService service ) {
     ...
     */
    void doLockFeature( LockFeature request, HttpResponseWrapper response )
